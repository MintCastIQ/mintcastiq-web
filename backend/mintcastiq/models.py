...
class DimCardHash(models.Model):
    ...
    card = models.ForeignKey(DimCard, models.DO_NOTHING, blank=True, null=True)
...
class DimSessions(models.Model):
    user = models.ForeignKey('DimUsers', models.DO_NOTHING, blank=True, null=True)
...
class FactChecklistItem(models.Model):
    ...
    parallel = models.ForeignKey(DimParallel, models.DO_NOTHING)
...
class FactInventory(models.Model):
    ...
    user = models.ForeignKey(DimUsers, models.DO_NOTHING, blank=True, null=True)
    checklist_item = models.ForeignKey(FactChecklistItem, models.DO_NOTHING, blank=True, null=True)
    grade = models.ForeignKey(DimGrade, models.DO_NOTHING, blank=True, null=True)
...
class FactMetrics(models.Model):
    ...
    event = models.ForeignKey(FactCardEvents, models.DO_NOTHING, blank=True, null=True)
